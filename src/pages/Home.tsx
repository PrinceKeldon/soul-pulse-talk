      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-20 md:py-32 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
            <Link to="/podcast">
              <Button size="lg" className="gap-2">Listen to Global Pulse chat pod<Headphones className="h-5 w-5" />
                Listen to Today's Pulse
              </Button>
            </Link>
            <a href="https://pulsechat.online" target="_blank" rel="noopener noreferrer">
              <Button size="lg" variant="outline" className="gap-2">Go to pulse<MessageCircle className="h-5 w-5" />
        ...
        <section className="py-20 border-t border-border">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              The Pulse Podcast is humanity's daily reflection — an AI-generated soundscape of the world's emotional heartbeat.
            </p>
            <Link to="/podcast">
              <Button size="lg">
